...
- [ ] **2.2.3** Card・Container コンポーネント（アクセシビリティ考慮：セマンティック構造）
...
- [ ] **2.3.1** MCPサーバープロジェクト初期化
- [ ] **2.3.2** Vitest + Testing Library セットアップ
- [ ] **2.3.3** axe-core自動テスト導入
- [ ] **2.3.4** markuplint セットアップ（HTML品質・アクセシビリティチェック）
- [ ] **2.3.5** アクセシビリティガイドライン策定（コンポーネント作成時の観点整理）
- [ ] **2.3.6** UIコンポーネントストーリー作成
- [ ] **2.3.7** TypeScript型定義自動生成
- [ ] **2.3.8** コンポーネントドキュメント生成
