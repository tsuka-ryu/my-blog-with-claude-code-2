...
- [ ] **2.2.2** コンポーネントテンプレート生成機能
- [ ] **2.2.3** コンポーネントバリデーション機能
- [ ] **2.2.4** Storybook セットアップ
- [ ] **2.2.5** Vitest + Testing Library セットアップ
- [ ] **2.2.6** axe-core自動テスト導入
- [ ] **2.2.7** markuplint セットアップ（HTML品質・アクセシビリティチェック）
- [ ] **2.2.8** アクセシビリティガイドライン策定（コンポーネント作成時の観点整理）

### 2.3 共有UIコンポーネント

- [ ] **2.3.1** Typography コンポーネント（アクセシビリティ考慮：見出し階層、読みやすさ）
- [ ] **2.3.2** Button・Link コンポーネント（アクセシビリティ考慮：フォーカス、キーボード操作、ARIA）
- [ ] **2.3.3** Card・Container コンポーネント（アクセシビリティ考慮：セマンティック構造）
- [ ] **2.3.4** Navigation・Header コンポーネント（アクセシビリティ考慮：ランドマーク、キーボード操作）
- [ ] **2.3.5** Footer コンポーネント（アクセシビリティ考慮：ランドマーク）
- [ ] **2.3.6** Loading・Error コンポーネント（アクセシビリティ考慮：aria-live、スクリーンリーダー）

### 2.4 コンポーネント品質保証

- [ ] **2.4.1** UIコンポーネントストーリー作成
- [ ] **2.4.2** ストーリーファイル自動生成
- [ ] **2.4.3** TypeScript型定義自動生成
- [ ] **2.4.4** コンポーネントドキュメント生成
- [ ] **2.4.5** デザインシステムドキュメント
- [ ] **2.4.6** コンポーネント単体テスト
- [ ] **2.4.7** Storybook インタラクションテスト
- [ ] **2.4.8** Lighthouse Accessibility監査

### 2.5 アプリケーション構造

- [ ] **2.5.1** app/layout.tsx 基本レイアウト
- [ ] **2.5.2** app/page.tsx ホームページ
- [ ] **2.5.3** app/posts/[slug]/page.tsx 記事詳細
- [ ] **2.5.4** app/posts/page.tsx 記事一覧
- [ ] **2.5.5** app/tags/[tag]/page.tsx タグ別記事一覧
- [ ] **2.5.6** app/search/page.tsx 検索結果ページ
